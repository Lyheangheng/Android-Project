package com.android.basic.android.ui.theme
...
private val LightColorScheme = lightColorScheme(
    ...
    onBackground = Color(0xFF51448D),
    onSurface = CyanLight,

    primaryContainer = DeepPurpleLight,
    secondaryContainer = IndigoLight,
    tertiaryContainer = LimeLight,
